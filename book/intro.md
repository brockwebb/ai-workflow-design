...
**Chapter 3: Data Cleaning and Imputation Workflows.** Where LLMs complement traditional edit and imputation methods (Fellegi-Holt, hot-deck) and where they do not. The ground truth problem is central: there are no labeled "actually wrong" records to train against. Survey design effects, stratification constraints, and complex sampling structures create requirements that off-the-shelf machine learning ignores.
